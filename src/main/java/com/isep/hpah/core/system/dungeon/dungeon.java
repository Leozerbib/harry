...
public class dungeon extends AbstractDungeon {
    public dungeon(String namechap, String place, String description, String description2, String description3, String description4, String description5, int ennemy, int boss, spell Spell) {
