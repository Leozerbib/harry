...
public class spell extends AbstractSpell{
    ...
    public static spell expectoPatronum = new spell("expectoPatronum",4, 25,30,1,"def",1,3,0,0.7,1.2,2);
    public static spell wigardiumLeviosa = new spell("wigardiumLeviosa",5,15,10,1,"tool",1,1,0,0,0,3);
